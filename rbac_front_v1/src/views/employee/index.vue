  ...
  <div>
    ...
    <el-card class="box-card">
      <el-row :gutter="20">
        ...
        <el-col :span="8">
          <el-select placeholder="部门" v-model="queryInfo.deptId">
            <el-option
    ...
    >
      <el-form :model="addForm" ref="addFormRefs" label-width="70px">
        ...
        <el-form-item label="部门" label-width="120px" prop="department.id">
          <el-select placeholder="部门" v-model="addForm.department.id">
            <el-option
                v-for="department in departmentlist"
                :key="department.id"
                :label="department.name"
    ...
    >
      <el-form :model="editForm" ref="editFormRefs" label-width="70px">
        ...
        <el-form-item label="部门" label-width="120px" prop="department.id">
          <el-select placeholder="部门" v-model="editForm.department.id">
            <el-option
                v-for="department in departmentlist"
                :key="department.id"
                :label="department.name"
